...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,823 | 🐛 686 | 🌐 Python | 📅 2023-03-23 - Build and deploy server-less Flask applications on AWS Lambda and API Gateway
...
* [Flask-Admin](https://github.com/flask-admin/flask-admin) ⭐ 6,068 | 🐛 127 | 🌐 Python | 📅 2026-08-09 - Simple and extensible administrative interface framework for Flask
...
* [Authlib](https://github.com/lepture/authlib) ⭐ 5,396 | 🐛 140 | 🌐 Python | 📅 2026-08-11 - Authlib is an ambitious authentication library for OAuth 1, OAuth 2, OpenID clients, servers and more.
...
* [Flask-Caching](https://github.com/sh4nks/flask-caching) ⭐ 934 | 🐛 28 | 🌐 Python | 📅 2026-08-13 - Adds easy cache support to Flask
...
* [Flask-WTF](https://github.com/lepture/flask-wtf) ⭐ 1,508 | 🐛 25 | 🌐 Python | 📅 2026-08-01 - Simple integration of Flask and WTForms, including CSRF, file upload and Recaptcha integration.

## Email

* [Flask-Mail](https://github.com/mattupstate/flask-mail/) ⭐ 641 | 🐛 26 | 🌐 Python | 📅 2026-06-10 - Flask-Mail adds SMTP mail sending to your Flask applications
...
* [celery](https://github.com/celery/celery/) ⭐ 28,785 | 🐛 801 | 🌐 Python | 📅 2026-08-13 - Distributed Task Queue
* [huey](https://github.com/coleifer/huey) ⭐ 6,005 | 🐛 0 | 🌐 Python | 📅 2026-08-05 - a little task queue for python
...
* [sentry-sdk](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 430 | 🌐 Python | 📅 2026-08-13 - Python client for [Sentry](https://sentry.io/welcome/).
...
* [elastic-apm](https://github.com/elastic/apm-agent-python) ⭐ 430 | 🐛 140 | 🌐 Python | 📅 2026-08-13 - Elastic APM agent for Python
...
* [Flask-CORS](https://github.com/corydolphin/flask-cors) ⭐ 932 | 🐛 39 | 🌐 Python | 📅 2026-06-09 - A Flask extension for handling Cross Origin Resource Sharing (CORS), making cross-origin AJAX possible
...
* [connexion](https://github.com/zalando/connexion) ⭐ 4,608 | 🐛 185 | 🌐 Python | 📅 2026-08-03 - Swagger/OpenAPI First framework for Python on top of Flask with automatic endpoint validation & OAuth2 support.
...
* [Flask-DebugToolbar](https://github.com/mgood/flask-debugtoolbar) ⭐ 978 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-03 - A port of the django debug toolbar to flask
...
* [pytest-flask](https://github.com/pytest-dev/pytest-flask) ⭐ 499 | 🐛 17 | 🌐 Python | 📅 2026-07-13 - A set of pytest fixtures to test Flask applications
...
* [Discover Flask - Full Stack Web Development with Flask](https://github.com/realpython/discover-flask) ⭐ 4,548 | 🐛 6 | 🌐 Python | 📅 2020-09-30
...
* [airflow](https://github.com/apache/incubator-airflow) ⭐ 46,471 | 🐛 1,863 | 🌐 Python | 📅 2026-08-13 - Airflow is a system to programmatically author, schedule and monitor data pipelines.
...
* [securedrop](https://github.com/freedomofpress/securedrop) ⭐ 3,871 | 🐛 459 | 🌐 Python | 📅 2026-08-13- an open-source whistleblower submission system that media organizations can use to securely accept documents from and communicate with anonymous sources.
...
* [indico](https://github.com/indico/indico) ⭐ 2,099 | 🐛 886 | 🌐 Python | 📅 2026-08-13 - a general-purpose event management web-based solution. It includes a full-blown conference organization workflow as well as tools for meeting management and room booking. It provides as well integration with video-conferencing solutions.
...
* [Skylines](https://github.com/skylines-project/skylines) ⭐ 407 | 🐛 107 | 🌐 Python | 📅 2026-08-11 - Live tracking, flight database and competition framework
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,956 | 🐛 268 | 🌐 Python | 📅 2026-07-10 - Simple and rapid application builder framework, built on top of Flask. includes detailed security, auto form generation, google charts and much more
* [cookiecutter-flask](https://github.com/sloria/cookiecutter-flask) ⭐ 4,724 | 🐛 24 | 🌐 Python | 📅 2025-12-02
