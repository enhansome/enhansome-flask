...
* [Source Code](https://github.com/pallets/flask) ⭐ 72,203 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - Flask itself, hosted by Pallets.
* [Quart](https://github.com/pallets/quart) ⭐ 3,664 | 🐛 25 | 🌐 Python | 📅 2026-08-29 - Official ASGI counterpart of Flask, with a compatible API.
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,070 | 🐛 130 | 🌐 Python | 📅 2026-09-01 - Extensible admin interface for managing application data.

### APIs

* [Flask-RESTful](https://github.com/flask-restful/flask-restful) ⭐ 6,914 | 🐛 145 | 🌐 Python | 📅 2024-07-19 - Lightweight helpers for building REST APIs.
* [Eve](https://github.com/pyeve/eve) ⭐ 6,747 | 🐛 29 | 🌐 Python | 📅 2026-03-24 - REST API framework powered by Flask and MongoDB.
* [Connexion](https://github.com/spec-first/connexion) ⭐ 4,612 | 🐛 184 | 🌐 Python | 📅 2026-08-03 - Spec-first OpenAPI framework that can run on Flask.
...
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,136 | 🐛 39 | 🌐 Python | 📅 2026-09-01 - Flask web API framework with marshmallow validation and OpenAPI generation.
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest) ⭐ 719 | 🐛 59 | 🌐 Python | 📅 2026-09-01 - Marshmallow-first REST framework with automatic OpenAPI.
...
* [Authlib](https://github.com/authlib/authlib) ⭐ 5,413 | 🐛 144 | 🌐 Python | 📅 2026-08-31 - OAuth 1, OAuth 2, and OpenID Connect clients and servers.
...
* [Flask-Security](https://github.com/pallets-eco/flask-security) ⭐ 698 | 🐛 6 | 🌐 Python | 📅 2026-09-06 - Account management, authentication, and authorization. Continues Flask-Security-Too.
...
* [Flask-Caching](https://github.com/pallets-eco/flask-caching) ⭐ 934 | 🐛 1 | 🌐 Python | 📅 2026-09-04 - Caching support with multiple backends.
...
* [Flask-Migrate](https://github.com/miguelgrinberg/Flask-Migrate) ⭐ 2,404 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Database migrations for Flask-SQLAlchemy via Alembic.
* [Flask-MongoEngine](https://github.com/MongoEngine/flask-mongoengine) ⭐ 830 | 🐛 45 | 🌐 Python | 📅 2024-01-18 - MongoEngine integration with WTForms support.
* [Advanced Alchemy](https://github.com/litestar-org/advanced-alchemy) ⭐ 799 | 🐛 60 | 🌐 Python | 📅 2026-08-17 - SQLAlchemy companion with repositories, Alembic helpers, and a first-party Flask extension.
...
* [Sentry](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 390 | 🌐 Python | 📅 2026-09-04 - Error tracking SDK with a Flask integration.
* [OpenTelemetry](https://github.com/open-telemetry/opentelemetry-python-contrib) ⭐ 1,091 | 🐛 664 | 🌐 Python | 📅 2026-09-02 - Tracing and metrics instrumentation, including Flask.
* [nplusone](https://github.com/jmcarp/nplusone) ⭐ 1,068 | 🐛 24 | 🌐 Python | 📅 2022-11-25 - Detects N+1 queries when using Flask-SQLAlchemy.
* [Flask-DebugToolbar](https://github.com/pallets-eco/flask-debugtoolbar) ⭐ 978 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-03 - In-browser debug toolbar, ported from Django.
...
* [Elastic APM](https://github.com/elastic/apm-agent-python) ⭐ 431 | 🐛 142 | 🌐 Python | 📅 2026-08-31 - Application performance monitoring for Flask.
...
* [Flask-Marshmallow](https://github.com/marshmallow-code/flask-marshmallow) ⭐ 887 | 🐛 26 | 🌐 Python | 📅 2026-09-01 - Marshmallow integration for serialization and validation.
...
* [Flask-Limiter](https://github.com/alisaifee/flask-limiter) ⭐ 1,206 | 🐛 6 | 🌐 Python | 📅 2026-05-10 - Rate limiting for Flask routes.
...
* [Celery](https://github.com/celery/celery) ⭐ 28,864 | 🐛 734 | 🌐 Python | 📅 2026-09-06 - Distributed task queue commonly used with Flask.
* [Huey](https://github.com/coleifer/huey) ⭐ 6,026 | 🐛 0 | 🌐 Python | 📅 2026-09-04 - Small Redis-backed task queue.
* [Dramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,311 | 🐛 65 | 🌐 Python | 📅 2026-09-02 - Fast alternative to Celery, with [Flask-Dramatiq](https://flask-dramatiq.readthedocs.io/) available.
...
* [flask-jsonrpc](https://github.com/cenobites/flask-jsonrpc) ⭐ 292 | 🐛 12 | 🌐 Python | 📅 2026-08-31 - JSON-RPC support for Flask.
...
* [Discover Flask](https://github.com/realpython/discover-flask) ⭐ 4,544 | 🐛 6 | 🌐 Python | 📅 2020-09-30 - Full-stack Flask series from Real Python.
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,341 | 🐛 17 | 🌐 Python | 📅 2026-04-13 - Introduction to Flask, test-driven development, and JavaScript.
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,958 | 🐛 269 | 🌐 Python | 📅 2026-07-10 - Rapid app builder with security, auto CRUD, and charts.
...
* [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) ⭐ 3,003 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Docker image with uWSGI, Nginx, and Flask.
...
* [Apache Superset](https://github.com/apache/superset) ⭐ 74,666 | 🐛 592 | 🌐 Python | 📅 2026-09-06 - Data exploration and visualization platform.
* [Apache Airflow](https://github.com/apache/airflow) ⭐ 46,754 | 🐛 2,175 | 🌐 Python | 📅 2026-09-06 - Platform to author, schedule, and monitor workflows.
* [Redash](https://github.com/getredash/redash) ⭐ 28,781 | 🐛 801 | 🌐 Python | 📅 2026-09-03 - Query and visualize data from many sources.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,969 | 🐛 256 | 🌐 Python | 📅 2026-09-04 - Email alias service that protects personal inboxes.
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,881 | 🐛 461 | 🌐 Python | 📅 2026-09-06 - Whistleblower submission system for newsrooms.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,409 | 🐛 217 | 🌐 Python | 📅 2026-09-03 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,660 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - Classic forum software built with Flask.
* [Indico](https://github.com/indico/indico) ⭐ 2,105 | 🐛 886 | 🌐 Python | 📅 2026-09-03 - Event management system developed at CERN.
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 408 | 🐛 107 | 🌐 Python | 📅 2026-09-04 - Live tracking and flight database for gliding.
...
* [Zappa](https://github.com/zappa/Zappa) ⭐ 3,692 | 🐛 22 | 🌐 Python | 📅 2026-07-15 - Deploy WSGI apps to AWS Lambda and API Gateway.
